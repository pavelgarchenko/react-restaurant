  ...
  return (
    <div className="header" data-test="header">
      ...
      <div className="header-info">
        <h2 className="available-tables" data-test="available-tables">
          Available Tables: <span className="number" data-test="tables-number">{available} / {NUMBER_OF_TABLES}</span>
        </h2>
